...
class Othertask extends CI_Controller
{

	public $pagename = 'othertask';
	...
	public $title = 'Assigned To Other';
	...
	public function index()
	{
		...
		$this->load->view($this->pagename . '/view_new', $this->data);
	}
	public function mySavedTasks()
	{
		...
		// exit;
		// print_r($this->notificationmail->sendMail());
		// exit;
	...
	public function allTasks()
	{
		...
		// exit;
		if (isset($_GET['req_id']) && $_GET['req_id'] != '')
			$this->data['records'] = $this->task->totaTlasks($this->data['ADMIN_ID'], $this->data['ADMIN_ROLE_ID'], $_GET['req_id']);
		
		else
			$this->data['records'] = $this->task->totalTasks($this->data['ADMIN_ID'], $this->data['ADMIN_ROLE_ID']);
	...
	{
// 	 $test = $this->input->post('complexity');
// 	 $test1 = $this->input->post('priority');
...
// 	print_r($this->common->saveTable($this->tasks_table, $task_data));
// 						exit;
                           ...
                           $message = "<html>
                                    ...
                                    <table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#CCCCCC' style= ' border: 1px solid black;
                                              ...
                                              <tr>
                                                ...
                                                <td width='100%' bgcolor='#FFFFEC'style= ' border: 1px solid black;
                                                      table-layout: fixed;'>".$this->input->post('task_related_to')."</td>
                                              </tr>
                                        </table>
                                    </body>
                                    </html>";
                                ...
                                $this->email->from('info@addsum.co', 'admin');
                                //$this->email->to('dinesh@digitowork.com ');
                                $this->email->cc($this->input->post('email_cc'));
...
//	echo "<pre/>"	;print_r($this->data['complexity']);die;
	...
	//	
		...
		$this->data['allTasks'] = $this->task->allAssignedTasks($this->data['ADMIN_ID']);
				//echo "<pre/>"; print_r($this->data['allTasks']);die;
//echo "<pre/>"; print_r(	$this->data['allTasks']);die;
