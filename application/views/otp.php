...
<div class="login-box">
  ...
  <div class="login-box-body" style="padding: 5px 20px;">
    ...
    <p class="login-box-msg" style="padding: 20px;"><b>Enter OTP</b></p>
    <form action="" method="post" id="ART_FORM_EID">
    <div class="form-group has-feedback">
      <input name="otp" type="text" class="form-control validate[required]" id="username" placeholder="OTP">
    ...
    <div class="row">
      <!-- /.col -->
      <div class="col-sm-12" >
        <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit">Authenticate OTP</button>
