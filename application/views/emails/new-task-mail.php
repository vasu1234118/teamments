...
<p style="font-size: 26px; line-height: 1.2; word-break: break-word; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 31px; margin: 0;"><span style="font-size: 26px;"><span style=""><span style="">A New Task  </span></span>has been Assigned Task-ID:<?php echo taskId($task_data->id)?>.</span></p>
</div>
</div>
<!-- [if mso]></td></tr></table><![endif] -->
</div>
...
<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;">
<strong>Steps to be taken:</strong><span style="font-size: 17px; mso-ansi-font-size: 18px;"><?php echo $task_data->step_executed; ?></span></p>
...
<p style="font-size: 14px; line-height: 1.2; text-align: left; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">  <strong><a href="mailto:info@digitohub.com" rel="noopener" style="text-decoration: underline; color: #66BECD;" target="_blank"></a></strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
