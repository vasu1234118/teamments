...
<p style="font-size: 14px; line-height: 1.2; text-align: left; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><strong>HI <?php echo $user_data->display_name?>,</strong></p>
</div>
</div>
...
<p style="font-size: 26px; line-height: 1.2; word-break: break-word; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 31px; margin: 0;"><span style="font-size: 26px;"><span style=""><span style="">A Update in your Task-ID</span></span><?php echo taskId($task_data->id)?></span></p>
</div>
</div>
<!-- [if mso]></td></tr></table><![endif] -->
</div>
...
<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;">
<strong>Task-ID:</strong><span style="font-size: 17px; mso-ansi-font-size: 18px;"><p><?php echo taskId($task_data->id); ?></p></span></p>
<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;">
<strong>Task Name:</strong><span style="font-size: 17px; mso-ansi-font-size: 18px;"><p><?php echo $task_data->name; ?></p></span></p>

<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;">
<strong>Task Status:</strong><span style="font-size: 17px; mso-ansi-font-size: 18px;"><?php echo $task_data->status_name; ?></span></p>



<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;">
<strong>Task Goal:</strong><span style="font-size: 17px; mso-ansi-font-size: 18px;"><?php echo $task_data->description; ?></span></p>


<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;">
<strong>Task Description:</strong><span style="font-size: 17px; mso-ansi-font-size: 18px;"><?php echo $task_data->precautions; ?></span></p>


<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;">
<strong>Steps to be executed:</strong><span style="font-size: 17px; mso-ansi-font-size: 18px;"><?php echo $task_data->step_executed; ?></span></p>


<p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;"><strong>Click to View Task:</strong> </p>

<?php if($user_type=='user'){ ?>
	<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;"><?php echo base_url('taskinbox/edit/'.md5($task_data->id))?></span></p>
<?php } else { ?>
	<p style="font-size: 17px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;"><?php echo base_url('assignedtasks/show/'.md5($task_data->id))?></span></p>
<?php }  ?>

<!-- <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;"> </p>
...
<div style="border-collapse: collapse;display: table;width: 100%;background-color:#033742;">
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth" src="<?php echo base_url('assets/')?>images/logo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 158px; display: block;" title="Image" width="158"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div style="font-size: 12px; line-height: 1.2; color: #353535; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
<p style="font-size: 14px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><strong>	</strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://www.facebook.com/" target="_blank"><img alt="Facebook" height="32" src="<?php echo base_url('assets/')?>images/facebook@2x.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Facebook" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://twitter.com/" target="_blank"><img alt="Twitter" height="32" src="<?php echo base_url('assets/')?>images/twitter@2x.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Twitter" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://instagram.com/" target="_blank"><img alt="Instagram" height="32" src="<?php echo base_url('assets/')?>images/instagram@2x.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Instagram" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://www.linkedin.com/" target="_blank"><img alt="LinkedIn" height="32" src="<?php echo base_url('assets/')?>images/linkedin@2x.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="LinkedIn" width="32"/></a></td>
</tr>
</tbody>
</table>
</td>
...
<!-- <p style="font-size: 14px; line-height: 1.2; text-align: left; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">Phone 55-5698-4589 / <strong><a href="mailto:info@digitohub.com" rel="noopener" style="text-decoration: underline; color: #66BECD;" target="_blank">info@digitohub.com</a></strong></p> -->
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
