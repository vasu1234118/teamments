    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <!--<h3 class="box-title">Inactive Users Details</h3>-->
                    ...
                    <tbody id="test">
                      <?php   $index=1; foreach($users as $row){ ?>
                        <tr>
                          ...
                          <td><a href="<?php echo base_url() ?>users/edit/<?php echo md5($row->id); ?>"><i class="fa fa-pencil"></i> Edit</a>&nbsp;&nbsp;<?php if($row->id!=$ADMIN_ID){ ?>|&nbsp;&nbsp;<a href="<?php echo base_url() ?>users/delete/<?php echo md5($row->id); ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-trash-o"></i> Delete</a><?php } ?></td>
                        </tr>
                        <?php $index++;} ?>
                    </tbody>
