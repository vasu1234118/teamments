          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input name="title"  disabled type="text" class="form-control validate[required]" id="name" value="<?php echo $record_info->title; ?>">
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  <input name="from_date" disabled type="text" class="form-control validate[required]" class="form-control pull-right" id="leave_edit">
