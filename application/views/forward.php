...
<script type="text/javascript">
  ...
  function milestone(value)
  {
    ...
    $("#milestone_id").html(data);
       ...
       console.log(err);
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input name="forward_cc" type="text" class="tag-input" value="">
      ...
      <div class="text-center"><a href="<?php echo site_url($pagename); ?>" class="btn btn-default btn-md" name="submit">Cancel</a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="hidden" name="edit_id" value="<?php echo md5($record_info->id); ?>" /><input type="submit" class="btn btn-primary btn-md" name="update" value="Forward" onclick="return confirm('Are you sure you want to  assign to Task ?')"; />&nbsp;&nbsp;&nbsp;&nbsp;<!--<button type="submit" class="btn btn-warning btn-md" name="save">Save</button>--></div>
