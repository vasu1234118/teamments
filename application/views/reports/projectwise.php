...
<?php $this->load->view('include/left_nav.php'); ?>
  ...
  <div class="content-wrapper">
   ...
   $admin_id = $proadmin_data['TM_ID']; $user=$this->db->get_where('users', array('id'=>$admin_id))->row(); $user->role  ?>
            <div class="col-md-6">
                <div class="form-group">
    ...
    <div class="text-center">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="btn btn-primary btn-md" name="submit" value="Submit" /></div>
