          ...
          <div class="row">
           <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="date"   name="started_on" id="started_on" class="form-control validate[required]" />
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="date"   name="last_date" id="estimated_ended_on" class="form-control validate[required]" />
	 ...
	 $admin_id = $proadmin_data['TM_ID']; $user=$this->db->get_where('users', array('id'=>$admin_id))->row() ?>
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select onchange="onProjectChange1(this.value),milestone(this.value), assignproject(this.value),getusers (this.value)"  class="form-control"  name="pr_id" id="project_id" required="required">
                    <option value="">Select Project</option>
                    <?php if(($user->role=='1') || ($user->role=='2') ||($user->role=='3')){ ?>
                    <?php $pr=$this->db->get('projects')->result(); foreach($pr as $pr2){  ?>
                   
                    <option value="<?php echo $pr2->id; ?>"><?php echo $pr2->name; ?></option>
                    <?php } ?>
        ...
        <div class="box-header with-border">
         <!--  <h3 class="box-title"><?php echo $title; ?> </h3> -->
          ...
          <div class="box-tools pull-right">
            <a href="<?php echo base_url() ?>assignedtasks/add_new" class="btn btn-danger btn-xs"><i class="fa fa-plus-circle"></i> Add New <?php echo $add_title; ?></a>
          </div>
        </div>
        <!-- /.box-header -->
