...
<div class="login-box">
  ...
  <div class="login-box-body" style="padding: 5px 20px;">
    ...
    <div class="form-group has-feedback">
      <input name="username" type="text" class="form-control validate[required]" id="username" placeholder="User Name">
      <span class="glyphicon glyphicon-user form-control-feedback"></span>
    </div>
    <div class="form-group has-feedback">
      <input name="password" type="password" class="form-control validate[required]" id="password" placeholder="Password">
