              ...
              <table id="referral_table" class="display responsive nowrap" cellspacing="0" width="100%">
                  <thead>
                        <tr>
                            ...
                            <th style="width: 21%;">Requirement Title</th>
                            <th style="width: 21%;">Requirement Description</th>
                    ...
                    <tbody>
                      ...
                      <?php $index=1; foreach($records as $row){ ?>
                        <tr>
                          ...
                          <td><?php echo $row->requirement_goal;  ?></td>
                          <td><?php echo $row->display_name.' ('.$row->user_role.') '; ?></td>
                          <td><?php echo $row->scope_of_work==1?'<span class="label label-success">In-Scope</span>':'<span class="label label-warning">Out-of-Scope</span>'; ?></td>
                          ...
                          <td>
                            ...
                            <!--<a href="<?php //echo site_url($assigned_page.'/add_new/'.md5($row->project_id)); ?>"><i class="fa fa-plus"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp; -->
                            <a href="<?php echo site_url($pagename.'/show/'.md5($row->id)); ?>"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp;
