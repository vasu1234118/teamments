          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input name="name" type="text" class="form-control validate[required]" id="project_name">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
            ...
            <!-- <div class="col-md-6">
              <div class="form-group">
                ...
                <input name="sort_order" type="text" class="form-control validate[required] allow_number" id="name">
              </div>
            </div> -->
            <!-- <div class="col-md-3">
              <div class="form-group">
