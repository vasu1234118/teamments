                    ...
                    <tbody>
                      <?php  foreach($users as $row){ ?>
                        <tr>
                          ...
                          <td><a href="<?php echo base_url() ?>users/edit/<?php echo md5($row->id); ?>"><i class="fa fa-pencil"></i> Edit</a>&nbsp;&nbsp;<?php if($row->id!=$ADMIN_ID){ ?>|&nbsp;&nbsp;<a href="<?php echo site_url($pagename.'/delete/'.md5($row->id)); ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-trash-o"></i> Delete</a><?php } ?></td>
                        </tr>
                        <?php $index++;} ?>
                    </tbody>
