...
<div class="login-box">
  ...
  <div class="login-box-body" style="padding: 5px 20px;">
    ...
    <p class="login-box-msg" style="padding: 20px;"><b>Reset Password</b></p>
    <form action="" method="post" id="ART_FORM_EID">
    <div class="form-group has-feedback">
      <input name="newpassword" type="password" class="form-control validate[required]" id="username" placeholder="New Password">
      <span class="glyphicon glyphicon-lock form-control-feedback"></span>
    </div>
    <div class="form-group has-feedback">
      <input name="conpassword" type="password" class="form-control validate[required]" id="username" placeholder="confirm password">
      <span class="glyphicon glyphicon-lock form-control-feedback"></span>
    </div>
    ...
    <div class="row">
      <!-- /.col -->
      <div class="col-sm-12" >
        <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit">Reset password</button>
